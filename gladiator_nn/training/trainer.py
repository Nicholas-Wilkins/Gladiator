"""
Training loop for Gladiator-NN.

Identical champion/challenger framework as the CPU engine:
...
The mode switches RANDOM → MUTATION once the champion wins 100 consecutive
...
from gladiator_nn.training.match import MatchResult, play_match

logger = logging.getLogger(__name__)

RANDOM_WIN_THRESHOLD = 100
...
class Trainer:
    ...
    def run(self) -> None:
        ...
        logger.info("NN training started. Champion: %s", state.champion)
        ...
        logger.info("NN training stopped gracefully.")
