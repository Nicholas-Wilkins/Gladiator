"""
Rich terminal dashboard for monitoring Gladiator-Mini training in real time.
"""
...
from gladiator_mini.training.trainer import Mode, TrainerState, RANDOM_WIN_THRESHOLD
...
def _render_header(state: Optional[TrainerState]) -> Panel:
    if state is None:
        return Panel("Waiting for first match...", title="Gladiator-Mini", border_style="dim")
    ...
    return Panel(grid, title="[bold white]GLADIATOR-MINI[/bold white]", border_style="blue")
