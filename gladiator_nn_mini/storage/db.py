"""
SQLite persistence for Gladiator-NN-Mini.
...
from gladiator_nn_mini.bot.bot import NNBot, NNBotParams
from gladiator_nn_mini.training.match import MatchResult
...
class DB:
    def __init__(self, path: str | Path = "gladiator_nn_mini.db") -> None:
        self.path = Path(path)
