"""
NNBot and NNBotParams for Gladiator-NN-Mini.

Identical to the full NN engine; only the module import paths differ.
"""
...
from gladiator_nn_mini.bot.network import ChessNet
from gladiator_nn_mini.training.search import best_move
